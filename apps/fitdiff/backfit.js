...
class FitParser {
  ...
  parse(content, callback) {
    ...
    fitObj.profileVersion = profileVersion;    // Only keep arrays needed for the comparison app
    const records = [];
    const devices = [];
    const file_ids = [];
    const sessions = [];
    ...
    while (loopIndex < crcStart) {
      ...
      loopIndex = nextIndex;      switch (messageType) {
        case 'record':
          if (!startDate) {
        ...
        case 'file_id':
          ...
          break;
        case 'event':
          // Only track timer events for paused time calculation
    ...
    }    // Only return the data needed for comparison
